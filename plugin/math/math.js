    ...
    const t = () => {
        ...
        return {
            ...
            init: function (n) {
                ...
                i.tex2jax = { ...e.tex2jax, ...a.tex2jax }, i.mathjax = i.config = null;
                (function (t, e) {
                    let n = document.querySelector("head"),
                        a = document.createElement("script");
                    a.type = "text/javascript", a.src = t;
                    let i = () => { "function" == typeof e && (e.call(), e = null) };
                    a.onload = i, a.onreadystatechange = () => { "loaded" === this.readyState && i() }, n.appendChild(a);
                })(s, (function () {
                ...
                init: function (a) {
                    ...
                    const { local: o, version: l, extensions: r, ...c } = s;
                     let //d = s.local || "https://cdn.jsdelivr.net/npm/katex",
                        //u = s.local ? "" : "@" + s.version,
                        // p = "https://cdn.tonycrane.cc/utils/katex.min.css",
                        p="./plugin/math/katex.min.css",
                        h = "./plugin/math/mhchem.min.js",            
                        x = "./plugin/math/auto-render.min.js",
                        m = ["./plugin/math/katex.min.js"];
                    s.extensions && s.extensions.includes("mhchem") && m.push(h), m.push(x);
                    const f = () => { renderMathInElement(a.getSlidesElement(), c), t.layout() };
                    (t => {
            ...
            let t, e = {
                ...
                startup: {
                    ready: () => {
                        ...
                        MathJax.startup.promise.then((() => { t.layout() }))
                    }
                }
            };
            return {
                ...
                init: function (n) {
                    ...
                    i.mathjax = null, window.MathJax = i;
                    (function (t, e) {
                        let n = document.createElement("script");
                        n.type = "text/javascript", n.id = "MathJax-script", n.src = t, n.async = !0, n.onload = () => { "function" == typeof e && (e.call(), e = null) }, document.head.appendChild(n)
                    })(s, (function () {
                        t.addEventListener("slidechanged", (function (t) { MathJax.typeset() }))
                    }))
                }
            }
        }
